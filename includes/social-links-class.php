...
class Social_Links_Widget extends WP_Widget {
    ...
    public function getForm( $instance ) {
        ...
        <p>
        <label for="<?php echo $this->get_field_id('twitter_link'); ?>"><?php _e('Icon:'); ?></label>
        ...
        <p>
        <label for="<?php echo $this->get_field_id('linkedin_link'); ?>"><?php _e('Icon:'); ?></label>
        ...
        <p>
        <label for="<?php echo $this->get_field_id('google_link'); ?>"><?php _e('Icon:'); ?></label>
